            ...
            <div class="columns">
                <div class="column is-6 is-offset-3">
                    <div class="section-content has-text-centered">
                        <h3>تعديل بيانات صقر (مستشفي)</h3>
                        <h3>Edit Falcon Details (Hospital)</h3>
                        <p>
                            تقوم المستشفي باستكمال الاجرائات
                        </p>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="columns centered">
                                                <div class="column is-12 is-4-desktop">
                                                    ...
                                                    <input type="text" name="P_FAL_RING_NO" class="ui-input"
                                                           value="{{old('P_FAL_RING_NO')}}"
                                                           autocomplete="off">
                                                    @if($errors->has('P_FAL_RING_NO'))
                                                        <span class="tag color-red">{{$errors->first('P_FAL_RING_NO')}}</span>
                                                    @endif
                                                </div>
                                                <div class="column is-12 is-4-desktop">
                                                    ...
                                                    <input type="text" name="P_FAL_INJ_DATE" class="ui-input date"
                                                           value="{{old('P_FAL_INJ_DATE')}}"
                                                           autocomplete="off">
                                                    @if($errors->has('P_FAL_INJ_DATE'))
                                                        <span class="tag color-red">{{$errors->first('P_FAL_INJ_DATE')}}</span>
                                                    @endif
                                                </div>
                                                <div class="column is-12 is-4-desktop">
                                                    ...
                                                    <select name="P_FAL_INJ_HOSPITAL" class="ui-input">
                                                        @foreach(getStaticData()['lookup6'] ?? [] as $item)
                                                            <option value="{{$item['code']}}">{{$item['label']}}</option>
                                                        @endforeach
                                                    </select>
                                                    @if($errors->has('P_FAL_INJ_HOSPITAL'))
                                                        <span class="tag color-red">{{$errors->first('P_FAL_INJ_HOSPITAL')}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
