            ...
            <div class="columns">
                <div class="column is-6 is-offset-3">
                    <div class="section-content has-text-centered">
                        ...
                        <h3>تعديل طلب استخراج شهادة بعدم وجود مخالفات بيئية</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-5">
            <div class="columns is-multiline mt-2">
                ...
                <div class="column is-9-desktop is-12-tablet">
                    {{Form::open([
                        'method'=>'post',
                        'route'=>['post-update-certificate',$request->id],
                                    ...
                                    <div class="row">
                                        <div class="offset-3 col-md-6">
                                            <div class="shadow-lg p-3 ">
                                                ...
                                                <br>
                                                <a href="{{$request->file_detail[0]->file}}" class="btn btn-success" target="_blank">عرض</a>
                                                <br><br>
                                        ...
                                        <div class="offset-3 col-md-6">
                                            <div class="shadow-lg p-3 ">
                                                ...
                                                <br>
                                                <a href="{{$request->file_detail[1]->file}}" class="btn btn-success" target="_blank">عرض</a>
                                                <br><br>
                                        ...
                                        <div class="offset-3 col-md-6">
                                            <div class="shadow-lg p-3 ">
                                                ...
                                                <br>
                                                <a href="{{$request->file_detail[2]->file}}" class="btn btn-success" target="_blank">عرض</a>
                                                <br><br>
                                        ...
                                        <div class="offset-3 col-md-6">
                                            <div class="shadow-lg p-3 ">
                                                ...
                                                <a href="{{$request->file_detail[3]->file}}" class="btn btn-success" target="_blank">عرض</a>
                                                <br><br>
                                                @endif
                                            </div>
                                        </div>
