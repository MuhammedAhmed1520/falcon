        ...
        <div class="container pr-4 bg-white">
            ...
            <div class="alert alert-warning mt-5" style="background: #ff9777;border: 1px solid #000">
                <p class="lead font_bold text-center">
                    قائمة بالشركات المعتمدة لدي الهيئة فى مجال فحص وتدقيق والمطابقة لشحنات المواد الكيميائية المستوردة
                    والمصدرة
                </p>
            </div>
                ...
                <div class="col-12">
                    <div style="overflow-x:scroll">
                        <table class="table table-bordered table-striped font_bold">
                            ...
                            <tbody>
                            @foreach($officeAgentsCheck as $officeAgent)
                                <tr>
            ...
            <div class="alert alert-warning mt-5" style="background: #ff9777;border: 1px solid #000">
                <p class="lead font_bold text-center">
                    قائمة بالشركات المعتمدة لدى الهيئة في مجال المختبرات البيئية
                </p>
            </div>
                ...
                <div class="col-12">
                    <div style="overflow-x:scroll">
                        <table class="table table-bordered table-striped font_bold">
                            ...
                            <tbody>
                            @foreach($officeAgentsLab as $officeAgent)
                                <tr>
                                    <td>{{$officeAgent->office_name_ar}}</td>
                                    <td>
                                        <ul style="list-style-type: square">
