<div class="row mt-4">
    <div class="col-md-12">
        ...
        @if(checkSendAllowed($office_agent))
            <button type="button" class="btn btn-danger float-right" data-toggle="modal" id="employee_add_modal_btn"
...
<div class="row mt-4">
    <div class="col-md-12">
        ...
        @if(checkSendAllowed($office_agent))
            <button type="button" class="btn btn-danger float-right" data-toggle="modal" onclick="loadEmployessData()"
