                ...
                <h5 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false"
                       aria-controls="collapseSix">
                        <i class="icon icon-info mr-0 text-danger"></i>
                        متطلبات ملفات الاجهزة والمعدات
                    </a>
                </h5>
            </div>
