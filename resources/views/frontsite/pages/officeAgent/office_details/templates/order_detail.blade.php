    ...
    <div class="col-md-12 mt-3">
        <nav>
            <div class="nav nav-tabs" id="nav-tab2" role="tablist">
                <a class="nav-item nav-link font-weight-bold active company_info_tab" id="nav-home-tab2" data-toggle="tab"
                   href="#nav-home2"
                ...
                <a class="nav-item nav-link font-weight-bold partner_info_tab" id="nav-profile-tab2" data-toggle="tab"
                   href="#nav-profile2"
                   ...
                   role="tab" aria-controls="nav-profile" aria-selected="false">
                    ...
                    @endif
                    بيانات الشركاء</a>
                <a class="nav-item nav-link font-weight-bold another_branch_info_tab" id="nav-contact-tab2" data-toggle="tab"
                   href="#nav-contact2"
