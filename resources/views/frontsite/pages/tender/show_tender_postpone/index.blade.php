                        ...
                        @if($tender->status->title == 'available')
                            ...
                            <div class="columns is-multiline"> 
                                <div class="column is-6-desktop">
                                    {{Form::open([
                                        'route'=>'handleTenderPostponeRequest',
                                        'method'=>'post',
                                    ])}} 
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-6-desktop">
                                            <input type="text" name="date"
                                                   ...
                                                   placeholder="التاريخ:*" required="" value=""
                                                   autocomplete="off">
                                        </div>
                                        ...
                                        <div class="column has-text-centered">
                                            @if(getConfig('GOOGLE_RECAPTCHA_KEY'))
                                                <input type="submit" id="s_btn2" class="btn is-disabled" disabled
                                                       value="مد العطاء">
                                            @else
                                                <input type="submit" class="btn" value="مد العطاء">
                                            @endif
                                        </div>
                                        {{Form::close()}}
                                    </div>
