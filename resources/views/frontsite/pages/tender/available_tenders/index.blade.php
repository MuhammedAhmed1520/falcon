...
{{--                        <h5 class="small-headline">نظام الممارسات</h5>--}}
                        <h3>عرض جميع الممارسات المطروحة</h3>
                    </div>
                </div>
            </div>
        </div>
...
{{--                    @include('frontsite.pages.tender.menu')--}}
                ...
                <div class="column is-10-desktop is-12-tablet">
                    <table class="table" id="myTable">
                        <thead>
                        <tr>
                            <th><abbr title="Position">رقم الممارسة</abbr></th>
                            <th>الموضوع</th>
                            <th><abbr title="Played">تاريخ الطرح</abbr></th>
                            <th><abbr title="Points">اخر موعد للعطاء</abbr></th>
                            <th></th>
                        </tr>
                        </thead>
                        <tfoot>
