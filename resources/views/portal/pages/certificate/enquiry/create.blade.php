        ...
        <div class="container-fluid mb-5">
            <div class="row direction mt-2">
                ...
                <div class="col-md-12">
                    {{Form::open([
                        'method'=>'post',
                        'route'=>'post-portal-certificate',
                        'enctype'=>'multipart/form-data'
                    ])}}

                    <div class="row direction mt-2">
                        <div class="col-md-6 mt-1">
                            <input type="text" name="company_name" class="ui-input" placeholder="{{__('portal.company_name')}}"
                                   required=""
                        ...
                        <div class="col-md-6 mt-1">
                            <input type="text" name="owner_name" class="ui-input" placeholder="{{__('portal.company_owner_name')}}"
                    ...
                    <div class="row direction">
                        ...
                        <div class="col-md-6 mt-1">
                            <input type="email" name="c_email" class="ui-input" placeholder="{{__('portal.email_confirm')}}"
                                   required=""
                                   value="{{old('c_email')}}"
                                   autocomplete="off">
                    ...
                    <div class="row direction">
                        ...
                        <div class="col-md-6 mt-1">
                            <input type="tel" name="phone" class="ui-input arabicnumber" placeholder="{{__('portal.phone')}}"
                                   required=""
                                   value="{{old('phone')}}"
                                   autocomplete="off">
                            @if($errors->has('phone'))
                    ...
                    <div class="row direction">
                        <div class="col-md-6 mt-1 reason">
                        ...
                        <div class="col-md-6 mt-1">
                            <div class="shadow-lg p-3 ">
                                ...
                                @if($errors->has('license_file'))
                                    <span
                                        class="has-text-danger">({{$errors->first('license_file')}})</span>
                                @endif
                                <br>
                        ...
                        <div class="col-md-6 mt-1">
                            <div class="shadow-lg p-3 ">
                                ...
                                @if($errors->has('signature_file'))
                                    <span
                                        class="has-text-danger">({{$errors->first('signature_file')}})</span>
                                @endif
                                <br>
                        ...
                        <div class="col-md-6 mt-1">
                            <div class="shadow-lg p-3 ">
                                ...
                                @if($errors->has('civil_ssn_file'))
                                    <span
                                        class="has-text-danger">({{$errors->first('civil_ssn_file')}})</span>
                                @endif
                                <br>
                        ...
                        <div class="col-md-6 mt-1">
                            <div class="shadow-lg p-3 ">
                                ...
                                @if($errors->has('other_file'))
                                    <span
                                        class="has-text-danger">({{$errors->first('other_file')}})</span>
                                @endif
                                <br>
