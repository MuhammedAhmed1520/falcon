...
{{--                                    <span class="icon is-small"><i class="icon icon-file-text" aria-hidden="true"></i> </span>--}}
                            ...
                            <div class="columns is-multiline">
                                <div class="column is-6-desktop">
                                    {{Form::open([
                                        'route'=>'handleTenderPostponeRequestPortal',
                                        'method'=>'post',
                                    ])}}
                                    <div class="row is-multiline">
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <input type="text" name="date"
                                                   class="ui-input date_time has-text-weight-bold"
                                                   placeholder="{{__('portal.date')}}" required="" value=""
                                                   autocomplete="off">
                                        </div>
                                        <div class="col-md-12"></div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            @if(getConfig('GOOGLE_RECAPTCHA_KEY'))
                                                <input type="submit" id="s_btn2" class="btn btn-danger is-disabled" disabled
                                                       value="{{__('portal.postpone')}}">
                                            @else
                                                <input type="submit" class="btn btn-danger" value="{{__('portal.postpone')}}">
                                            @endif
                                        </div>
                                        {{Form::close()}}
                                    </div>
