...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.environmentalRequests.all.templates.header')
                @include('pages.environmentalRequests.all.templates.content')
            </div>
        </div>
    </div>
@endsection
        ...
        function deleteRow(id) {
             Swal.fire({
                ...
                preConfirm: function (allow) {
                    if (allow) {
                        $.ajax({
                            url: "{{route('deleteEnvironmentalRequests')}}",
                            method: "post",
                            data: {
                                _token: '{{csrf_token()}}',
                                id: id,
