                        ...
                        <div class="row  mb-4 f_para">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="row fine">
                                    ...
                                    <div class="col-md-4 main_c_fine">
                                    ...
                                    {{--<div class="row fine">--}}
                                        {{--<div class="col-md-4 p_person_fine">--}}
                                            {{--<span class="input input--isao">--}}
                                                ...
                                                {{--<span class="input__label-content input__label-content--isao">--}}
                                                    {{--{{__('violation.person_fine')}}--}}
                                                    {{--@if($errors->has('paragraph_person_fine.'.$para))--}}
                                                        {{--<br>--}}
                                                        {{--<span class="text-danger">({{$errors->first('paragraph_person_fine.'.$para)}})</span>--}}
                                                    {{--@endif--}}
                                                {{--</span>--}}
                                            {{--</label>--}}
                                          {{--</span>--}}
