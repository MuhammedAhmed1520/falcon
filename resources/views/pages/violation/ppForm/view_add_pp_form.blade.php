...
<main>
    ...
    <div id="edits_buttons">
        <ul class="list-unstyled list-inline">
            ...
            <li>
                <button id="submit_edit" class="btn btn-danger">تعديل النموذج</button>
            </li>
            <li>
...
<script>
    ...
    $(document).ready(function () {
        ...
        {{--$('#violation_personal_only').hide().css('color', 'red');--}}
        ...
        {{--$('#violation_punishment_number').text('{{$violation_data["punishment"]}}').css('color', 'red');--}}
        {{--$('#violation_serial').text('{{$violation_data["serial"]}}').css('color', 'red');--}}
        {{--$('#violation_serial_2').text('{{$violation_data["serial"]}}').css('color', 'red');--}}
        {{--$('#violation_subject_number').text('{{$violation_data["subject"]}}').css('color', 'red');--}}
    });
