...
@section('scripts')
    ...
    <script>
        ...
        $('#remove_username').on('click',function () {
            $('#email').val('');
            $('#username').val('');
        });
        ...
        $('#form').submit(function (e) {
            ...
            let mail_val = mail.val();
            let fulldomain = '{{str_replace(',','.',implode('',explode('dc=' , env('LDAP_BASE_DN'))))}}';
            console.log(mail_val.includes(fulldomain));
            if(mail_val.includes(fulldomain)){
                username.val(mail_val);
            }else{
                username.val(mail_val +'@'+ fulldomain);
