                        ...
                        <div class="col-md-12">
                            @foreach($classification_degrees as $classification_degree)
                                <div class="alert alert-danger class_degree_ids" role="alert"
                                     ...
                                     {{--@endif--}}
                                     @if((count($office_agent['human_resources'] ?? []) >= 5) && $office_agent['classification_degree_id'] == 16) style="display: none;"
                                     @endif
    ...
    <div class="col-md-12">
        ...
        @if(count($office_agent['attachments'] ?? []))
            <button type="button" class="btn btn-info mr-1 ml-1 float-right" data-toggle="modal"
                    ...
                    onclick="addFilesViewer('{{collect($office_agent['attachments'] ?? [])}}')">
                تصفح المرفقات
            </button>
        @endif
    </div>
