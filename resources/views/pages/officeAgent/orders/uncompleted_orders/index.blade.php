...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.orders.uncompleted_orders.templates.header')
                @include('pages.officeAgent.orders.uncompleted_orders.templates.content')
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script>
        ...
        {{--                        </td>--}}
        {{--                            <td width="65%">--}}
        {{--                                <b>${payment.paymentable[0].knet_data ? payment.paymentable[0].knet_data.result : ''}</b>--}}
        {{--                        </td>--}}
        {{--                    </tr>--}}
        {{--                    <tr>--}}
        {{--                        <td>--}}
        ...
        {{--                        </td>--}}
        {{--                        <td width="65%">--}}
        {{--                            <b>${(!payment.paymentable[0].knet_data && payment.paymentable[0].status == 1) ? 'KNET' : 'CASH'}</b>--}}
        {{--                        </td>--}}
        {{--                    </tr>--}}
        {{--                    <tr>--}}
        {{--                        <td>--}}
        ...
        {{--                        </td>--}}
        {{--                        <td width="65%">--}}
        {{--                            <b>${payment.paymentable[0].status == 0 ? '<i class="la la-close text-danger"></i>' : '<i class="la la-check text-success"></i>'}</b>--}}
        {{--                        </td>--}}
        {{--                    </tr>--}}
        {{--                    <tr>--}}
        {{--                        <td>--}}
