...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.offices.approve_certify.templates.header')
                @include('pages.officeAgent.offices.approve_certify.templates.content')
            </div>
        </div>
    </div>
@endsection
    ...
    <script>
        $(document).ready(function () {
            ...
            $('select[name="payment_type_id"]').on('change',function(){
                let val = $(this).val();
                $('input[name="receipt_code"],input[name="notes"],input[name="image"]').val(null);
