...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.offices.getAllActivitiesDecisionsView.templates.header')
                @include('pages.officeAgent.offices.getAllActivitiesDecisionsView.templates.content')
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script>
        ...
        function deleteDecision(id) {
            ...
            if (allow) {
                $.ajax({
                    url: "{{route('handleDeleteActivitiesDecisionsRequest')}}",
                    method: "post",
                    data: {
                        _token: '{{csrf_token()}}',
                        id: id
