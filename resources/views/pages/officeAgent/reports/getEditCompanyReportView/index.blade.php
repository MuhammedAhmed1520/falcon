...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.reports.getEditCompanyReportView.templates.header')
                @include('pages.officeAgent.reports.getEditCompanyReportView.templates.content')
            </div>
        </div>
    </div>
@endsection
