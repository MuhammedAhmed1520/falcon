...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.reports.getOfficeAgentDevicesReportView.templates.header')
                @include('pages.officeAgent.reports.getOfficeAgentDevicesReportView.templates.content')
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script>
        function printTrigger(){
           let comp = $('select[name="office_agent_id"] option:selected').text();
