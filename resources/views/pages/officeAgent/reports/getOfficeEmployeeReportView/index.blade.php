...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.reports.getOfficeEmployeeReportView.templates.header')
                @include('pages.officeAgent.reports.getOfficeEmployeeReportView.templates.content')
            </div>
        </div>
    </div>
@endsection
