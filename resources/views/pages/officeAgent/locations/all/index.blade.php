...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.locations.all.templates.header')
                @include('pages.officeAgent.locations.all.templates.content')
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script>
        ...
        function removeGov(id) {
            let confirms = confirm('{{__('violation.are_sure')}}');
            if (confirms){

                $.ajax({
                    url: "{{route('handleDeleteLocations')}}",
                    method: "delete",
                    data: {
                        _token: '{{csrf_token()}}',
                        id: id
