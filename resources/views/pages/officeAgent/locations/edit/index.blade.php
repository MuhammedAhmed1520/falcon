...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.officeAgent.locations.edit.templates.header')
                @include('pages.officeAgent.locations.edit.templates.content')
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script>
        ...
        let counter = {{count($governorate->cities ?? [])}};
