...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.tenders.tender.all.templates.header')
                @include('pages.tenders.tender.all.templates.content')
            </div>
        </div>
    </div>
@endsection
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.status) {
                                    ...
                                    oTable.fnDeleteRow(oTable.find(`#tender_${id}`).eq(0))
                                }
                            }
                        })
                    }
