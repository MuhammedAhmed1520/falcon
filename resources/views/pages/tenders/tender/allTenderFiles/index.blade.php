...
@section('content')
    <div class="skeleton-nav--center">
        <div class="container-fluid">
            <div class="row">
                @include('pages.tenders.tender.allTenderFiles.templates.header')
                @include('pages.tenders.tender.allTenderFiles.templates.content')
                @include('pages.tenders.tender.allTenderFiles.templates.edit')
            </div>
        </div>
    </div>
@endsection
        ...
        function remove(id) {
            Swal.fire({
                ...
                preConfirm: function (allow) {
                    if (allow) {
                        $.ajax({
                            url: "{{route('deleteTenderFileDetails',['id'=>request()->id])}}",
                            method: "delete",
                            data: {
                                _token: '{{csrf_token()}}',
                                id: id
