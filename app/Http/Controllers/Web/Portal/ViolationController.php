...
class ViolationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('portal.pages.violation.enquiry.index', compact('categories', 'actions'));
    }
    ...
    public function handleViolationEnquiry(Request $request)
    {
        ...
        return redirect()->route('violationEnquiryGetDataPortal', $request->only(['category_id', 'ssn', 'type', 'data']));
    ...
    public function getEnquiryData(Request $request)
    {
        ...
        return view('portal.pages.violation.enquiry_view.index', compact('violations'));
    }
    ...
    public function getEnquiryPayViolation(Request $request, $id)
    {
        ...
        return view('portal.pages.violation.payment.index', compact('violation'));
    }
