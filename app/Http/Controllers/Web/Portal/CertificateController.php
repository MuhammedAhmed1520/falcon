...
class CertificateController extends Controller
{
    ...
    {
        $is_active = 1;
        return view('portal.pages.certificate.enquiry.filter',compact('is_active'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('portal.pages.certificate.enquiry.create', compact('party', 'reason', 'is_active'));
    }
...
//        return view('portal.pages.certificate.enquiry.index', compact('request'));
    }
    ...
    public function edit($id)
    {
        ...
        $request = $response['data']['request'] ?? null;
        return view('portal.pages.certificate.enquiry.edit', compact('request', 'party', 'reason', 'is_active'));
    }
