...
class FrontController extends Controller
{
    ...
    {
        return view('frontsite.pages.index.index');
    }

    public function servicesGate()
    {
        return view('frontsite.pages.index.servicesGate');
    }

    public function tenderRegisterCompany()
    {
        $is_active = 1;
        return view('frontsite.pages.tender.create_company.index', compact('is_active'));
    }
    ...
    public function tenderCompanyEnquiry(Request $request, $type)
    {
        ...
        return view('frontsite.pages.tender.company_reference.index',compact('buttonTitle'));
    }
    ...
    public function tenderResetCode(Request $request)
    {
        ...
        $is_active = 2;
        return view('frontsite.pages.tender.forget_code.index', compact('is_active'));
    }
    ...
    public function tenderCompanyStatus(Request $request, $code)
    {
        ...
        return view('frontsite.pages.tender.company_status.index', compact('company','messages','code'));
    }
    ...
    public function tenderCompanyUpdateFiles(Request $request, $code)
    {
        ...
        return view('frontsite.pages.tender.company_update_files.index', compact('files', 'company'));
    }
    ...
    public function availableTenders(Request $request)
    {
        ...
        return view('frontsite.pages.tender.available_tenders.index', compact('is_active', 'tenders'));
    }
    ...
    public function rejectTenders(Request $request)
    {
        ...
        return view('frontsite.pages.tender.reject_tenders.index', compact('is_active', 'tenders'));
    }
    ...
    public function approveTenders(Request $request)
    {
        ...
        return view('frontsite.pages.tender.approved_tenders.index', compact('is_active', 'tenders'));
    }
...
//        return $tenders;
        return view('frontsite.pages.tender.all_tenders.index', compact('is_active', 'tenders'));
    }
    ...
    public function showTenderDetails(Request $request, $id)
    {
        ...
        return view('frontsite.pages.tender.show_tender.index', compact('is_active', 'tender'));
    ...
    public function showTenderDetailsPostpone(Request $request, $id)
    {
        $is_active = 3;
        $tender = $this->tender->show($id)['data']['tender'] ?? null;
        return view('frontsite.pages.tender.show_tender_postpone.index', compact('is_active', 'tender'));
    ...
    public function showTenderPage(Request $request, $id)
    {
        ...
        return view('frontsite.pages.tender.tender_page.index', compact('page'));
    }
}
